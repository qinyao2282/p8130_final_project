...
cancer_lm = lm(target_death_rate ~ avg_ann_count + incidence_rate + income_cat + age_cat + pct_private_coverage + pct_asian + percent_married + avg_household_size, data = cancer_s)
