...
cancer_s = cancer_data_analysis %>%
  dplyr::select(target_death_rate, avg_ann_count, incidence_rate, pct_unemployed16_over, age_cat, pct_private_coverage, pct_white, pct_hs25_over, pct_hs18_24)
...
boot.fn<-function(data, index){
	return(coef(lm(target_death_rate ~ ., data = cancer_s, subset=index)))
}

boot(cancer_s, boot.fn, 100)
```
